import {
  ...
  strapiPrimaryButtonHoverStyle,
  strapiPrimaryButtonFocusStyle,
} from './btn-style';

export const injectColorPickerButton = () => {
  const interval = setInterval(() => {
    const modal = document.querySelector('[aria-labelledby="title"]');
    if (!modal) return;
    ...
    const firstInnerDiv = modal.querySelector('div > div');
    ...
    firstInnerDiv.insertBefore(btn, firstInnerDiv.firstChild);
